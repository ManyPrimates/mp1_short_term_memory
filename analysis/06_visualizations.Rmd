...
#                            trial = "Trial"))
# 
# saveRDS(model_draws, "../saves/conf_model_draws.rds")

model_draws <- readRDS("../saves/conf_model_draws.rds")
...
#                            trial = "Trial"))
# 
# saveRDS(model_fix, "../saves/conf_model_fixed.rds")

model_fix <- readRDS("../saves/conf_model_fixed.rds")
...
conf_plot <- model_plot %>%
  ...
  theme_minimal() +
  scale_fill_manual(
   values = c("firebrick", "lightgrey", "firebrick")
  )+
