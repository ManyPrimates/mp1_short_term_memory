...
a_all <- pwr.t.test( d = effect_sizes %>% filter(clade == "ape") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(a_all)%>%kable(digits = 2)
```
...
o_all <- pwr.t.test( d = effect_sizes %>% filter(clade == "old_world_monkey") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(o_all)%>%kable(digits = 2)
```
...
n_all <- pwr.t.test( d = effect_sizes %>% filter(clade == "new_world_monkey") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(n_all)%>%kable(digits = 2)
```
...
l_all <- pwr.t.test( d = effect_sizes %>% filter(clade == "lemur") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(l_all)%>%kable(digits = 2)
```
...
a_delay <- pwr.t.test( d = effect_sizes_delay %>% filter(clade == "ape") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(a_delay)%>%kable(digits = 2)
```
...
o_delay <- pwr.t.test( d = effect_sizes_delay %>% filter(clade == "old_world_monkey") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(o_delay)%>%kable(digits = 2)
```
...
n_delay <- pwr.t.test( d = effect_sizes_delay %>% filter(clade == "new_world_monkey") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(n_delay)%>%kable(digits = 2)
```
...
l_delay <- pwr.t.test( d = effect_sizes_delay %>% filter(clade == "lemur") %>% pull(d), sig.level = .05 , power = .8, type = c("one.sample"))

tidy(l_delay)%>%kable(digits = 2)
```
